...
limit_direction: N/A
---
# Validation — 2026-06-17 (nzdusd, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports nzdusd on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY SHORT 0.5855-0.5890 (ZC 6.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
- **COUNTER LONG 0.5750-0.5790 (ZC 6.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
