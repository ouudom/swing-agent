...
> **— D028 LIVE PASS 2026-06-16 18:50 UTC (carry block relaxed → per-zone EC) —** NO TRADE — PRIMARY SHORT 1.3440–1.3465 (0.44 H4ATR below spot 1.34288): D1 osc mid (Stoch55/W%R−39/RSI48), no SHORT E0; EC≈3 < 6.0 (ADX15.8 ranging floor). COUNTER LONG far (3.8 ATR). _Gates: VIX 16.2 (no veto); FOMC Wed 18:00 = forward-carry (allow+flatten 17:00 Wed), gbpusd/eurgbp gated earlier by UK CPI Wed 06:00 (flatten 05:00 Wed); own-CB-today (RBA→audusd) + JPY NO ZONES stay hard. No fresh T4-X shock; no new D1 close (next 00:00 UTC 06-17)._
