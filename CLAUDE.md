...
- Claude Code judgment runs through MCP only.
- Deterministic code computes numbers; Claude decides ambiguous market judgment.
...
```bash
claude mcp add --transport http swing-agent http://<host>:8766/mcp \
