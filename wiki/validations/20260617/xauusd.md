...
limit_direction: N/A
---
# Validation — 2026-06-17 (xauusd, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports xauusd on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY SHORT 4360-4390 (ZC 7.0)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
- **SECONDARY SHORT 4450-4485 (ZC 6.0)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
