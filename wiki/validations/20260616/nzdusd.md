...
> **— D028 LIVE PASS 2026-06-16 18:50 UTC (carry block relaxed → per-zone EC) —** NO TRADE — PRIMARY SHORT 0.5855–0.5890 (1.04 H4ATR below spot 0.58379): D1 mid/oversold (Stoch27/W%R−75/CCI−44), EXTREMES none, no E0; EC < 6.0 floor. COUNTER LONG far (2.9 ATR). _Gates: VIX 16.2 (no veto); FOMC Wed 18:00 = forward-carry (allow+flatten 17:00 Wed), gbpusd/eurgbp gated earlier by UK CPI Wed 06:00 (flatten 05:00 Wed); own-CB-today (RBA→audusd) + JPY NO ZONES stay hard. No fresh T4-X shock; no new D1 close (next 00:00 UTC 06-17)._
