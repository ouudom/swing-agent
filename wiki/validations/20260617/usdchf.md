...
limit_direction: N/A
---
# Validation — 2026-06-17 (usdchf, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports usdchf on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY SHORT 0.8005-0.8025 (ZC 8.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
