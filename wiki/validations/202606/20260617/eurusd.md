...
limit_direction: N/A
---
# Validation — 2026-06-17 (eurusd, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports eurusd on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY LONG 1.1500-1.1520 (ZC 7.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
- **SECONDARY SHORT 1.1618-1.1640 (ZC 7.0)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
