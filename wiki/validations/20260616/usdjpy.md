...
limit_direction: N/A
---
# Validation — 2026-06-16 (usdjpy, [[2026-W25]])

## No PENDING zones
W25 forecast published **NO ZONES** for usdjpy (triple block: BoJ MPM 06-16 + active MoF intervention regime (spot ~160, above trigger) + FOMC 06-17). Nothing to validate.

## Result
NO TRADE — no zones published; hard block (BoJ MPM 06-16 + active MoF intervention regime (spot ~160, above trigger) + FOMC 06-17). BoJ decision day (06-16). Per Step 1, log and stop.
...
> **— D028 LIVE PASS 2026-06-16 18:50 UTC (carry block relaxed → per-zone EC) —** NO TRADE — NO ZONES all week (standing) + BoJ decided today + active MoF regime. Not affected by D028. _Gates: VIX 16.2 (no veto); FOMC Wed 18:00 = forward-carry (allow+flatten 17:00 Wed), gbpusd/eurgbp gated earlier by UK CPI Wed 06:00 (flatten 05:00 Wed); own-CB-today (RBA→audusd) + JPY NO ZONES stay hard. No fresh T4-X shock; no new D1 close (next 00:00 UTC 06-17)._
