...
limit_direction: N/A
---
# Validation — 2026-06-17 (audusd, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports audusd on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY SHORT 0.7065-0.7110 (ZC 6.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
- **COUNTER LONG 0.6980-0.7000 (ZC 7.0)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
