...
limit_direction: N/A
---
# Validation — 2026-06-17 (gbpusd, [[2026-W25]])
...
## Q1+Q2 — Hard Blocks
- **V3 — own-CB-today (HARD).** US Federal Reserve FOMC statement 2026-06-17 03:11 UTC. `check_cb_calendar.py` reports gbpusd on the FOMC HARD-BLOCK list. No order limit may be emitted today.
...
## Q4 — Per-Zone
- **PRIMARY SHORT 1.3440-1.3465 (ZC 6.5)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
- **COUNTER LONG 1.3304-1.3330 (ZC 7.0)** — V3 own-CB-today hard block → ❌ NO TRADE (not scored).
